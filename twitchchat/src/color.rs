...
impl<'a> From<&'a str> for TwitchColor {
    fn from(s: &'a str) -> Self {
        match s.to_ascii_lowercase().as_str() {
            ...
            "blue violet" => TwitchColor::BlueViolet,
            "cadet blue" => TwitchColor::CadetBlue,
            "chocolate" => TwitchColor::Chocolate,
            "coral" => TwitchColor::Coral,
            "dodger blue" => TwitchColor::DodgerBlue,
            "firebrick" => TwitchColor::Firebrick,
            "golden rod" => TwitchColor::GoldenRod,
            "green" => TwitchColor::Green,
            "hot pink" => TwitchColor::HotPink,
            "orange red" => TwitchColor::OrangeRed,
            "red" => TwitchColor::Red,
            "sea green" => TwitchColor::SeaGreen,
            "spring green" => TwitchColor::SpringGreen,
            "yellow green" => TwitchColor::YellowGreen,
